...
var httph = {
	...
	post: function(host, path, object) {
		return httph.request(host, path, object, 'POST', httph.user, httph.password);
	},
	
	put: function(host, path, object) {
		return httph.request(host, path, object, "PUT", httph.user, httph.password);
	},
	
	patch: function(host, path, object) {
		return httph.request(host, path,  object, "PATCH", httph.user, httph.password);
	}
};
